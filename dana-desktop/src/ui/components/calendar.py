...
class CalendarComponent:
    ...
    def _create_calendar_grid(self) -> ft.Column:
        ...
        return ft.Column(controls=weeks, spacing=1, tight=True)  # Reduced spacing
                ...
                controls=[
                    ...
                    ft.Container(
                        content=ft.Container(
                            ...
                            border_radius=1.5,
                            bgcolor=(
                                colors.entry_indicator
                                if not is_selected
                                else colors.text_on_primary
                            ),
                        ),
...
class MiniCalendar(CalendarComponent):
    ...
    def _create_compact_header(self) -> ft.Row:
        ...
        prev_button = ft.IconButton(
            ...
            on_click=self._go_previous_month,
            style=ft.ButtonStyle(
                bgcolor={"": "transparent"}, padding=ft.padding.all(4)
            ),
        )
    ...
    def _create_compact_weekday_headers(self) -> ft.Row:
        ...
        return ft.Row(
            controls=headers, spacing=1, alignment=ft.MainAxisAlignment.CENTER
        )
    ...
    def _create_compact_calendar_grid(self) -> ft.Column:
        ...
        return ft.Column(controls=weeks, spacing=1, tight=True)
    ...
    def _create_compact_week_row(self, week: list) -> ft.Row:
        ...
        return ft.Row(controls=days, spacing=1, alignment=ft.MainAxisAlignment.CENTER)
