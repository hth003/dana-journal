...
class StorageIntegrationService:
    ...
    def __init__(self, vault_path: str, auto_save_config: AutoSaveConfig = None):
        ...
        self.auto_save_manager = AutoSaveManager(
            self.file_manager, 
            auto_save_config or AutoSaveConfig()
        )
    ...
    def load_entry(self, entry_date: date, use_cache: bool = True) -> Optional[JournalEntry]:
    ...
    def create_entry(self, entry_date: date, title: str = None, content: str = "") -> Optional[JournalEntry]:
    ...
    def save_entry_now(self, entry_date: date, title: str, content: str, 
    ...
    def queue_auto_save(self, entry_date: date, title: str, content: str, 
    ...
    def get_entries_in_range(self, start_date: date, end_date: date) -> list[JournalEntry]:
    ...
    def shutdown(self) -> None:
        ...
        try:
            ...
            if self.has_pending_saves():
                ...
                failed_saves = [date for date, success in results.items() if not success]
                if failed_saves:
...
def create_storage_service(vault_path: str = None, auto_save_config: AutoSaveConfig = None) -> StorageIntegrationService:
    """
    ...
    if vault_path is None:
        ...
        if not vault_path:
            raise ValueError("No vault path configured. Please complete onboarding first.")
