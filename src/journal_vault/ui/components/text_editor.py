...
class AutoSaveManager:
    ...
    def __init__(self, save_callback: Callable[[str], None], delay_seconds: float = 2.0):
...
class MarkdownHelper:
    ...
    @staticmethod
    def apply_bold(text: str, selection_start: int, selection_end: int) -> tuple[str, int, int]:
    ...
    @staticmethod
    def apply_italic(text: str, selection_start: int, selection_end: int) -> tuple[str, int, int]:
