...
class DanaWisdomComponent:
    ...
    def _build_component(self) -> None:
        ...
        self._regenerate_progress_ring = ft.ProgressRing(
            width=16, height=16, stroke_width=2, color=colors.primary, visible=False
        )
        ...
        self._regenerate_button_container = ft.Row(
            controls=[self.regenerate_button, self._regenerate_progress_ring],
            tight=True,
            spacing=8,
        )
                    ...
                    ft.Container(
                        content=ft.Container(
                            ...
                            border_radius=RADIUS[
                                "sm"
                            ],  # Smaller radius for compactness
                            ...
                            border=ft.border.all(
                                1, colors.accent + "15"
                            ),  # Very subtle sage green border
                        ),
                        # Height will be controlled by expansion state
                        height=(
                            0 if not self.is_expanded else 250
    ...
    def _toggle_expand(self) -> None:
        ...
        content_container = self.container.content.controls[
            1
